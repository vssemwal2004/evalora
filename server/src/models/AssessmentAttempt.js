...
const assessmentAttemptSchema = new mongoose.Schema(
  {
    ...
    identityVerification: {
      ...
      selfieSource: { type: String, enum: ['live', 'upload'], default: 'live' },
      idCardSource: { type: String, enum: ['live', 'upload'], default: 'live' },
      selfieDescriptor: { type: [Number], default: undefined },
      idCardDescriptor: { type: [Number], default: undefined },
      idCardOcrText: { type: String, default: '' },
      idCardOcrConfidence: { type: Number, default: 0, min: 0, max: 100 },
      idCardMatchedFields: { type: [String], default: [] },
      idCardMatchedNameTokens: { type: [String], default: [] },
      capturedAt: Date,
      reviewedBy: {
        type: mongoose.Schema.Types.ObjectId,
        ref: 'User',
    ...
    locationVerification: {
      ...
      permissionState: {
        type: String,
        enum: ['granted', 'prompt', 'unsupported'],
        default: 'unsupported',
      },
      capturedAt: Date,
    },
    ...
    securityHold: {
      ...
      cameraRevalidationStatus: {
        type: String,
        enum: ['not_started', 'pending', 'passed', 'failed'],
        default: 'not_started',
      },
      cameraRevalidatedAt: Date,
      resolvedAt: Date,
    },
  },
  { timestamps: true }
